...
public class KDMFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        namaJudul = getResources().getStringArray(R.array.kdmJudul);
        gambar = getResources().obtainTypedArray(R.array.kdmGambar);
        deskripsi = getResources().getStringArray(R.array.kdmDeskripsi);
        kategori = "KDM";
